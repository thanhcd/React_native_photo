...
export const uploadFile = async (file, type) => {
  ...
  console.log("Uploading file:", file); // Log file trước khi tải lên
  try {
    ...
    console.log("File uploaded successfully:", uploadFile); // Log phản hồi
    const fileUrl = await getFilePreview(uploadFile.$id, type);
    return fileUrl;
  } catch (error) {
    console.error("Error uploading file:", error); // In lỗi ra console
