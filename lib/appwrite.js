...
import {project, database,userCollection,photoCollection,storageApp} from '@env';
...
export const config = {
  ...
  projectId: project,
  databaseId: database,
  userCollectionId: userCollection,
  photoCollectionId: photoCollection,
  storageId: storageApp,
};
